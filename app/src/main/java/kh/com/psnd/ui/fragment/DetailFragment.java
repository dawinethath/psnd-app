...
public class DetailFragment extends BaseFragment<FragmentDetailBinding> {
    ...
    private void bindView(@NonNull Staff staff) {
        ...
        if (staff.getStaffHistories() != null) {
            ...
            binding.adapterView2.setupUI(this, staff.getStaffHistories().getPosition(), callback, R.string.detail_label_13, R.string.detail_label_2);
            binding.adapterView3.setupUI(this, staff.getStaffHistories().getDepartment(), callback, R.string.detail_label_change_position, R.string.detail_label_14);
